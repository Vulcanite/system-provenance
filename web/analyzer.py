...
# Performs querying, building, filtering, ATT&CK inference, and exporting provenance graphs from Elasticsearch-stored events.
...
class ProvenanceGraph:
    ...
    # ------------------------------------------------------------------------
    # ATTACK INDICATOR AND NOISE FILTERING
    # ------------------------------------------------------------------------
